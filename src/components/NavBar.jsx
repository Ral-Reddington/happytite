  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg" style={{
        borderBottom:"2px solid #F2C94C", margin: "0 11.75rem 0 11.75rem"
      }}>
        <div className="container">
          ...
          <ul className="navbar-nav mb-2 mb-lg-0">
              <li className="nav-item" >
                <span className="nav-link menu-item" aria-current="page" onMouseOver={handleHoverState} onMouseOut={handleHoverStateOut}>
                  Home
                </span>
              </li> 
              <li className="nav-item">
